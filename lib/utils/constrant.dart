...
const String weatherApiKey='1667894835418326c1a0b0cd475ff1dd';
...
const List<String>cities=['Dhaka','Narayanganj','Uppsala','Vancuber','Dinajpur','Rajshahi','Panchagarh','Sylhet','Kushtia'];
